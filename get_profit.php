...
<body>
    ...
    if ($storeRow) {
        echo "<p><strong>상점명:</strong> " . $storeRow['STORE_NAME'] . "</p>";
    ...
    // 영수증 정보 출력
    echo "<h2>영수증 정보</h2>";
    $sqlReceipt = "SELECT * FROM RECEIPT WHERE store_id = :store_id";
    ...
    if (oci_fetch($stmtOrderDetail)) {
        echo "<table>";
        echo "<tr><th>상품 수량</th><th>중간 가격</th><th>영수증 ID</th><th>상품 ID</th><th>상품 이름</th></tr>";
